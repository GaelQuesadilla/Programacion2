...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < total; i++) {
            sales[i] = terminal.requestDouble("Ingresa las ventas del día " + (i + 1));
        }
        ...
        terminal.Print("El promedio de las ventas es: " + String.format("%.2f", insertionSort.getAverage()));
        terminal.Print("La mediana de las ventas es: " + String.format("%.2f", insertionSort.getArray()[total / 2])); // array[7]
