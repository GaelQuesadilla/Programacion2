...
public class Terminal {
    ...
    public Cat requestCat() {
        String name = this.requestString("Ingresa el nombre del gato");
        String race = this.requestString("Ingresa la raza del gato");
        int age = this.requestInt("Ingresa la edad del gato ( en años )");
